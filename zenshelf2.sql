...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2025 at 07:56 PM
...
INSERT INTO `books` (`id`, `title`, `author`, `isbn`, `category`, `available`, `description`, `average_rating`) VALUES
(1, 'Book Title 1', 'Author 1', '1234567890', 'Fiction', 1, 'Description of Book 1', 4.5),
(2, 'Book Title 2', 'Author 2', '0987654321', 'Non-Fiction', 1, 'Description of Book 2', 3.8);
...
CREATE TABLE `users` (
  ...
  `role` varchar(50) NOT NULL COMMENT 'Peran pengguna'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'adminUser ', 'admin@example.com', 'adminPass', 'admin'),
(2, 'memberUser ', 'member@example.com', 'memberPass', 'member');
